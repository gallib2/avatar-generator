...
export const isSittingPose = (pose) =>
	Object.keys(SittingPose).includes(pose);

export const isStandingPose = (pose) =>
	Object.keys(StandingPose).includes(pose);

export const isBustPose = (pose) =>
	Object.keys(BustPose).includes(pose);

export const adjustPeepsViewbox = (bodyPiece) => {
	let x = '-350',
		y = '-150',
		width = '1500',
		height = '1500';
...
export const distinguishBodyViewbox = (bodyPiece) => {
